...
public class TransporterMalfunctionException extends Exception{
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2109000228523333251L;
	...
	public TransporterMalfunctionException(String message, Throwable cause, boolean enableSuppression,
